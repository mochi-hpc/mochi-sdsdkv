...
# SDSDKV_VERSION_CURRENT
# SDSDKV_VERSION_REVISION
# SDSDKV_VERSION_AGE
#
# COPYRIGHT
...
AC_DEFUN([AX_SDSDKV_LIBTOOL_VERSION], [dnl
    ...
    SDSDKV_LIBVINFO="$SDSDKV_VERSION_CURRENT:$SDSDKV_VERSION_REVISION:$SDSDKV_VERSION_AGE"

    AC_SUBST([SDSDKV_VERSION_CURRENT])
    AC_SUBST([SDSDKV_VERSION_REVISION])
    AC_SUBST([SDSDKV_VERSION_AGE])
    AC_SUBST([SDSDKV_LIBVINFO])

    AC_DEFINE_UNQUOTED([SDSDKV_VERSION_CURRENT],
                       [$SDSDKV_VERSION_CURRENT],
                       [Current version.])

    AC_DEFINE_UNQUOTED([SDSDKV_VERSION_REVISION],
                       [$SDSDKV_VERSION_REVISION],
                       [Current revision.])

    AC_DEFINE_UNQUOTED([SDSDKV_VERSION_AGE],
                       [$SDSDKV_VERSION_AGE],
                       [Current age.])
])
